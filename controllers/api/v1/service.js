...
router.get('/:sessionId', function(req, res) {
	...
	wrapperService.getServiceResponse(req.params.sessionId,
			function(err, data) {
				if (err) {
...
router.get('/:sessionId/download/:fileId', function(req, res) {
	...
	logger.debug({
		request : 'Get file',
		instance : req.params.sessionId,
		file : req.params.fileId
	});

	wrapperService.getServiceFile(req.params.sessionId, req.params.fileId,
